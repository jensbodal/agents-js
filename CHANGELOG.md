...
* **extras:** MCP bus bridge consumer for gateway push-channel events ([e701411](https://github.com/jensbodal/agents-js/commit/e7014115caa2f90432500cf4d7cdc76da17f1e15))
...
* **gateway-runtime,cli:** multi-runtime data structure + CLI flags ([9b33b08](https://github.com/jensbodal/agents-js/commit/9b33b08645e3b86af051323a1a744871835a06e2))
* **gateway,host,a2a,acp-host:** multi-harness lane manager + agent-card harnesses surface ([e489d05](https://github.com/jensbodal/agents-js/commit/e489d056e6c5d4180f5834e4110ec55571fcbeae))
