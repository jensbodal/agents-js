...
<!-- Source of truth: packages/validation/src/acp.ts packages/validation/src/generated/acp-schema.ts (@hostValidator-tagged Map<ACPMethod, ACPMethodSchemaInfo> registries via ts-morph) -->
