...
> Thin re-export layer over [`@a2ui/web_core`](https://www.npmjs.com/package/@a2ui/web_core) v0.9 plus a curated ACP component catalog for agents-js.
...
A2UI-host-relevant `@a2ui/web_core` v0.9 surface (catalog, component,
